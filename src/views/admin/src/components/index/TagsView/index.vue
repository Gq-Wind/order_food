<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"20px 10px 0","margin":"0px auto 0","borderColor":"#344f60","overflow":"hidden","borderRadius":"8px 8px 0 0","background":"#fff","borderWidth":"0 0 1px","display":"block","width":"calc(100% - 60px)","fontSize":"14px","borderStyle":"solid","height":"auto"}'>
