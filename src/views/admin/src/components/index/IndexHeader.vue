<template>
	<div class="navbar">
		<div class="title"
			:style='{ "padding": "0 5px", "margin": "0px", "alignItems": "center", "textAlign": "center", "display": "flex", "justifyContent": "center", "overflow": "hidden", "top": "0", "left": "0px", "background": "#1e3c4f", "width": "210px", "position": "absolute", "order": "3", "height": "68px" }'>
			<el-image v-if="false" class="title-img"
			...
			<span class="title-name"
				:style='{ "padding": "0px", "lineHeight": "1.2", "fontSize": "15px", "color": "#fff", "fontWeight": "500" }'>{{ this.$project.projectName }}</span>
		</div>
		<el-dropdown @command="handleCommand" trigger="click"
			:style='{ "fontSize": "inherit", "position": "absolute", "right": "30px", "color": "inherit", "display": "inline-block", "zIndex": "9999" }'>
			<div class="el-dropdown-link" :style='{ "alignItems": "center", "display": "flex" }'>
				<el-image v-if="user"
					:style='{ "width": "32px", "margin": "0 10px", "objectFit": "cover", "borderRadius": "100%", "display": "inline-block", "height": "32px" }'
					:src="avatar ? this.$base.url + avatar : require('@/assets/img/avator.png')" fit="cover"></el-image>
				<span
					:style='{ "color": "inherit", "lineHeight": "32px", "fontSize": "14px" }'>{{ this.$storage.get('adminName') }}</span>
				<span class="icon iconfont icon-xiala"
					:style='{ "margin": "0 0 0 5px", "fontSize": "14px", "color": "inherit", "display": "none" }'></span>
			</div>
