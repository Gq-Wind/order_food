(function (undefined) {
  ...
  RotateVerify.prototype = {
    ...
    initCanvasImg: function () {
      ...
      this.sucLenMin =
        ((360 - this.settings.slideAreaNum - this.randRot) *
          (this.$slideDragWrap.width() - this.$slideDragBtn.width())) /
        360;
      this.sucLenMax =
        ((360 + this.settings.slideAreaNum - this.randRot) *
          (this.$slideDragWrap.width() - this.$slideDragBtn.width())) /
    ...
    drawImgCan: function (val) {
      ...
      _this.rotateImgCan.rotate(
        (this.randRot * Math.PI) / 180 +
          (_this.disLf * _this.aveRot * Math.PI) / 180
      );
      _this.rotateImgCan.translate(-_this.xPos, -_this.yPos);
      ...
      _this.$slideDragBtn.on("mousedown", function (e) {
        ...
        $(document).mousemove(function (e) {
          ...
          if (x < 0) {
            ...
            x >=
            _this.$slideDragWrap.width() - _this.$slideDragBtn.outerWidth()
          ) {
